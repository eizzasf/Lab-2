...
<nav>
  ...
  <i class="fas fa-bars"></i>
    ...
    <!---First section-->
  <div class="w3-container  w3-padding-64 w3-center" style="background-color: #FB1A35;">
    <label class="w3-xlarge">CUSTOMER PAGE</label>
    <br><br><br>
    <h1>The website is under development! Kindly wait :)</h1>
  </div>
